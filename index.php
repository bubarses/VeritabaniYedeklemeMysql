...
$backup_config = array(
    ...
    'DB_NAME' => 'istakipsistemi',//Database name to backup
    ...
    'SAVE_AS' => 'istakipsistemi-',//Prepend filename
...
print '<a href="./'.backupDB($backup_config).'" class="btn btn-primary">Download</a>';
